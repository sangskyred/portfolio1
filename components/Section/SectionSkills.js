...
const SectionSkills = () => {
    let listSkill = [
        ...
        {
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" stroke="currentColor" strokeWidth="0.5" className="bi bi-bounding-box-circles" viewBox="0 0 16 16">
